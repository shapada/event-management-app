...
abstract class BaseTaxonomy {
	...
	public function get_labels() {
		...
		return apply_filters( "event_manager_filter_{$this->get_name()}_taxonomy_labels", $labels );
	}
	...
	public function get_options() {
		...
		return apply_filters( "event_manager_filter_{$this->get_name()}_taxonomy_options", $options );
	}
